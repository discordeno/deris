...
export class ComponentInteraction extends Interaction {
  ...
  async createFollowup(
    ...
    return await this.client.executeWebhook.call(
      this.client,
      this.applicationID,
      this.token,
      { ...content, wait: true }
   ...
   */
  async createMessage(
    content: InteractionApplicationCommandCallbackData,
    file?: FileContent | FileContent[]
  ...
  async editMessage(
    ...
    return await this.client.editWebhookMessage.call(
      this.client,
      this.applicationID,
      this.token,
      messageID,
