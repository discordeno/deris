...
import { IntegrationOptions } from "../typings.js";
...
export class GuildIntegration extends Base {
  ...
  update(data: DiscordIntegration) {
  ...
  async delete(): Promise<void> {
    return await this.guild.client.deleteGuildIntegration.call(
      this.guild.client,
      this.guild.id,
      this.id
    );
  ...
  async edit(options: IntegrationOptions): Promise<void> {
    return this.guild.client.editGuildIntegration.call(
      this.guild.client,
      this.guild.id,
      this.id,
      options
  ...
  async sync(): Promise<void> {
    return this.guild.client.syncGuildIntegration.call(
      this.guild.client,
      this.guild.id,
      this.id
    );
