...
import { RequestGuildMembers } from "discordeno/*";
import { ApplicationCommandPermission } from "discordeno/transformers";
import {
...
import Client, { BigString, ImageFormat, ImageSize } from "../Client.js";
...
import GuildIntegration from "./GuildIntegration.js";
...
export class Guild extends Base {
  ...
  update(data: DiscordGuild) {
    ...
    if (data.splash !== undefined) {
      this._splash = data.splash
        ? this.client.iconHashToBigInt(data.splash)
        : undefined;
    }

    if (data.discovery_splash !== undefined) {
      this._discoverySplash = data.discovery_splash
        ? this.client.iconHashToBigInt(data.discovery_splash)
        : undefined;
    }

    if (data.banner !== undefined) {
      this._banner = data.banner
        ? this.client.iconHashToBigInt(data.banner)
        : undefined;
    }
    ...
    if (data.icon !== undefined) {
      this._icon = data.icon
        ? this.client.iconHashToBigInt(data.icon)
        : undefined;
    }
    ...
    // @ts-ignore Missing type in typings
  ...
  get banner(): string | undefined {
    return this._banner
      ? this.client.iconBigintToHash(this._banner)
      : undefined;
  }

  get bannerURL(): string | null {
    return this.banner
      ? this.client._formatImage(BANNER(this.id, this.banner))
      : null;
  }
  ...
  get iconURL(): string | null {
    return this.icon
      ? this.client._formatImage(GUILD_ICON(this.id, this.icon))
      : null;
  }

  get splash(): string | undefined {
    return this._splash
      ? this.client.iconBigintToHash(this._splash)
      : undefined;
  }

  get splashURL(): string | null {
    return this.splash
      ? this.client._formatImage(GUILD_SPLASH(this.id, this.splash))
      : null;
  }

  get discoverySplash(): string | undefined {
    return this._discoverySplash
      ? this.client.iconBigintToHash(this._discoverySplash)
      : undefined;
  }
  ...
  async addDiscoverySubcategory(
    categoryID: BigString,
    reason?: string
  ): Promise<DiscoverySubcategoryResponse> {
    return await this.client.addGuildDiscoverySubcategory.call(
      this.client,
      this.id,
      categoryID,
      reason
  ...
  async addMemberRole(
    ...
    return await this.client.addGuildMemberRole.call(
      this.client,
      this.id,
      memberID,
      roleID,
  ...
  async banMember(
    ...
    return await this.client.banGuildMember.call(
      this.client,
      this.id,
      userID,
      deleteMessageDays,
  ...
  async bulkEditCommands(
    commands: ApplicationCommand<ApplicationCommandTypes>[]
  ): Promise<ApplicationCommand<ApplicationCommandTypes>[]> {
    return await this.client.bulkEditGuildCommands.call(
      this.client,
      this.id,
      commands
    );
  ...
  async createChannel(
    ...
    return await this.client.createChannel.call(
      this.client,
      this.id,
      name,
      // @ts-ignore some eris magic at play here
  ...
  async createCommand(
    ...
    return await this.client.createGuildCommand.call(
      this.client,
      this.id,
      command
    );
  ...
  async createEmoji(options: EmojiOptions, reason?: string): Promise<Emoji> {
    return await this.client.createGuildEmoji.call(
      this.client,
      this.id,
      options,
      reason
  ...
  async createRole(
    ...
    return await this.client.createRole.call(
      this.client,
      this.id,
      options,
      reason
  ...
  async createSticker(
    ...
    return await this.client.createGuildSticker.call(
      this.client,
      this.id,
      options,
      reason
  ...
  async createTemplate(
    ...
    return await this.client.createGuildTemplate.call(
      this.client,
      this.id,
      name,
      description
  ...
  async delete(): Promise<void> {
    if (this.ownerID !== this.client.id)
      throw new Error(
        "To delete a guild, the bot must be the owner of the guild."
      );
  ...
  async deleteCommand(commandID: BigString): Promise<void> {
    return await this.client.deleteGuildCommand.call(
      this.client,
      this.id,
      commandID
    );
  ...
  async deleteDiscoverySubcategory(
    categoryID: BigString,
    reason?: string
  ): Promise<void> {
    return await this.client.deleteGuildDiscoverySubcategory.call(
      this.client,
      this.id,
      categoryID,
      reason
  ...
  async deleteEmoji(emojiID: BigString, reason?: string): Promise<void> {
    return await this.client.deleteGuildEmoji.call(
      this.client,
      this.id,
      emojiID,
      reason
  ...
  async deleteIntegration(integrationID: BigString): Promise<void> {
    return await this.client.deleteGuildIntegration.call(
      this.client,
      this.id,
      integrationID
    );
  ...
  async deleteRole(roleID: BigString, reason?: string): Promise<void> {
    return await this.client.deleteRole.call(
      this.client,
      this.id,
      roleID,
      reason
  ...
  async deleteSticker(stickerID: BigString, reason?: string): Promise<void> {
    return await this.client.deleteGuildSticker.call(
      this.client,
      this.id,
      stickerID,
      reason
  ...
  async deleteTemplate(code: string): Promise<void> {
    return await this.client.deleteGuildTemplate.call(
      this.client,
      this.id,
      code
    );
  ...
  dynamicBannerURL(format?: ImageFormat, size?: ImageSize): string | null {
    return this.banner
      ? this.client._formatImage(BANNER(this.id, this.banner), format, size)
      : null;
  }
  ...
  dynamicIconURL(format?: ImageFormat, size?: ImageSize): string | null {
    return this.icon
      ? this.client._formatImage(GUILD_ICON(this.id, this.icon), format, size)
      : null;
  }
  ...
  dynamicSplashURL(format?: ImageFormat, size?: ImageSize): string | null {
    return this.splash
      ? this.client._formatImage(
          GUILD_SPLASH(this.id, this.splash),
          format,
          size
        )
      : null;
  ...
  async edit(options: GuildOptions, reason?: string): Promise<Guild> {
    return await this.client.editGuild.call(
      this.client,
      this.id,
      options,
      reason
  ...
  async editChannelPositions(
    ...
    return await this.client.editChannelPositions.call(
      this.client,
      this.id,
      channelPositions
    );
  ...
  async editCommand(
    ...
    return await this.client.editGuildCommand.call(
      this.client,
      this.id,
      commandID,
      commands
  ...
  async editCommandPermissions(
    ...
    return await this.client.editCommandPermissions.call(
      this.client,
      this.id,
      commandID,
      permissions
  ...
  async editDiscovery(options: DiscoveryOptions): Promise<DiscoveryMetadata> {
    return await this.client.editGuildDiscovery.call(
      this.client,
      this.id,
      options
    );
  ...
  async editEmoji(
    ...
    return await this.client.editGuildEmoji.call(
      this.client,
      this.id,
      emojiID,
      options,
  ...
  async editIntegration(
    ...
    return await this.client.editGuildIntegration.call(
      this.client,
      this.id,
      integrationID,
      options
  ...
  async editMember(
    ...
    return await this.client.editGuildMember.call(
      this.client,
      this.id,
      memberID,
      options,
  ...
  async editRole(
    ...
    return await this.client.editRole.call(
      this.client,
      this.id,
      roleID,
      options,
  ...
  async editSticker(
    ...
    return await this.client.editGuildSticker.call(
      this.client,
      this.id,
      stickerID,
      options,
  ...
  async editTemplate(
    ...
    return await this.client.editGuildTemplate.call(
      this.client,
      this.id,
      code,
      options
  ...
  async editVoiceState(
    ...
    return await this.client.editGuildVoiceState.call(
      this.client,
      this.id,
      options,
      userID
  ...
  async editWelcomeScreen(
    ...
    return await this.client.editGuildWelcomeScreen.call(
      this.client,
      this.id,
      options
    );
  ...
  async editWidget(options: Widget): Promise<Widget> {
    return await this.client.editGuildWidget.call(
      this.client,
      this.id,
      options
    );
  ...
  async getAuditLog(options: GetGuildAuditLogOptions): Promise<GuildAuditLog> {
    return await this.client.getGuildAuditLog.call(
      this.client,
      this.id,
      options
    );
  ...
  async getCommand(
    ...
    return await this.client.getGuildCommand.call(
      this.client,
      this.id,
      commandID
    );
  ...
  async getCommandPermissions(
    ...
    return await this.client.getCommandPermissions.call(
      this.client,
      this.id,
      commandID
    );
  ...
  async getGuildCommandPermissions(): Promise<
    GuildApplicationCommandPermissions[]
  > {
    return await this.client.getGuildCommandPermissions.call(
      this.client,
      this.id
    );
  }
  ...
  async getRESTEmoji(emojiID: BigString): Promise<Emoji> {
    return await this.client.getRESTGuildEmoji.call(
      this.client,
      this.id,
      emojiID
    );
  ...
  async getRESTMember(memberID: BigString): Promise<Member> {
    return await this.client.getRESTGuildMember.call(
      this.client,
      this.id,
      memberID
    );
  ...
  /** Get a guild's members via the REST API. REST mode is required to use this endpoint. */
  async getRESTMembers(
    options?: GetRESTGuildMembersOptions
  ): Promise<Member[]> {
    return await this.client.getRESTGuildMembers.call(
      this.client,
      this.id,
      options
    );
  ...
  async getRESTSticker(stickerID: BigString): Promise<Sticker> {
    return await this.client.getRESTGuildSticker.call(
      this.client,
      this.id,
      stickerID
    );
  ...
  async kickMember(userID: BigString, reason?: string): Promise<void> {
    return await this.client.kickGuildMember.call(
      this.client,
      this.id,
      userID,
      reason
  ...
  permissionsOf(memberID: BigString | Member): Permission {
    const member = ["string", "bigint"].includes(typeof memberID)
      ? this.members.get(memberID as BigString)!
      : (memberID as Member);
  ...
  async removeMemberRole(memberID: BigString, roleID: BigString, reason?: string): Promise<void> {
    return await this.client.removeGuildMemberRole.call(
      this.client,
      this.id,
      memberID,
      roleID,
  ...
  async searchMembers(query: string, limit = 1): Promise<Member[]> {
    return await this.client.searchGuildMembers.call(
      this.client,
      this.id,
      query,
      limit
  ...
  async syncIntegration(integrationID: BigString): Promise<void> {
    return await this.client.syncGuildIntegration.call(
      this.client,
      this.id,
      integrationID
    );
  ...
  async unbanMember(userID: BigString, reason?: string): Promise<void> {
    return await this.client.unbanGuildMember.call(
      this.client,
      this.id,
      userID,
      reason
