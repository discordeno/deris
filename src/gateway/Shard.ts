...
import { ActivityPartial, BotActivityType, ClientPresence, GuildTextableChannel, RequestGuildMembersOptions, RequestMembersPromise, SelfStatus, SimpleJSON, TextableChannel } from '../typings.js';
import BrowserWebSocket from '../util/BrowserWebSocket.js';
...
// TODO: Verify types for having zlib-sync
let ZlibSync: typeof import('pako');
try {
...
export class Shard extends EventEmitter implements SimpleJSON {
     ...
     */
    editStatus(status: SelfStatus, activities?: ActivityPartial<BotActivityType>[] | ActivityPartial<BotActivityType>) {
    ...
    requestGuildMembers(guildID: string, options?: RequestGuildMembersOptions) {
        const opts = {
            guild_id: guildID,
    ...
    wsEvent(pkt: Required<DiscordGatewayPayload>) {
        switch (
            ...
            case 'PRESENCE_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordPresenceUpdate };
            ...
            case 'VOICE_STATE_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordVoiceState };
                ...
                if (!member) {
                    ...
                    const channel = guild.channels.find((channel) => (channel.type === ChannelTypes.GuildVoice || channel.type === ChannelTypes.GuildStageVoice) && channel.voiceMembers.get(packet.d.id));
                    if (channel) {
                ...
                if (oldChannelID != packet.d.channel_id) {
                    ...
                    if (packet.d.channel_id && (newChannel = guild.channels.get(packet.d.channel_id) as TextVoiceChannel | StageChannel) && (newChannel.type === ChannelTypes.GuildVoice || newChannel.type === ChannelTypes.GuildStageVoice)) {
            ...
            case 'TYPING_START': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordTypingStart };
            ...
            case 'MESSAGE_CREATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordMessage };

                const channel = this.client.getChannel(packet.d.channel_id) as TextableChannel;
                if (channel) {
            ...
            case 'MESSAGE_DELETE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordMessageDelete };
            ...
            case 'MESSAGE_DELETE_BULK': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordMessageDeleteBulk };
            ...
            case 'MESSAGE_REACTION_ADD': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordMessageReactionAdd };

                const channel = this.client.getChannel(packet.d.channel_id) as TextableChannel;
                let message: Message | { id: string; channel: TextableChannel | { id: string }; guildID?: string } | undefined;
                let member;
                if (channel) {
                    message = channel.messages.get(packet.d.message_id);
                    if ((channel as GuildTextableChannel).guild) {
                        if (packet.d.member) {
                            // Updates the member cache with this member for future events.
                            packet.d.member.id = packet.d.user_id;
                            member = channel.guild.members.update(packet.d.member, (channel as GuildTextableChannel).guild);
                        }
                    }
                }
                if (message instanceof Message) {
                    ...
                    if (packet.d.guild_id) {
                        ...
                        if (!(message.channel as GuildTextableChannel).guild) {
            ...
            case 'MESSAGE_REACTION_REMOVE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordMessageReactionRemove };
            ...
            case 'MESSAGE_REACTION_REMOVE_ALL': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordMessageReactionRemoveAll };
            ...
            case 'MESSAGE_REACTION_REMOVE_EMOJI': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordMessageReactionRemoveEmoji };
            ...
            case 'GUILD_MEMBER_ADD': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildMemberAdd };
            ...
            case 'GUILD_MEMBER_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildMemberUpdate };
            ...
            case 'GUILD_MEMBER_REMOVE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildMemberRemove };
            ...
            case 'GUILD_CREATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuild };
            ...
            case 'GUILD_DELETE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordUnavailableGuild };
            ...
            case 'GUILD_BAN_ADD': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildBanAddRemove };
            ...
            case 'GUILD_ROLE_CREATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildRoleCreate };
            ...
            case 'GUILD_ROLE_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildRoleUpdate };
            ...
            case 'GUILD_ROLE_DELETE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildRoleDelete };
            ...
            case 'INVITE_CREATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordInviteCreate };
            ...
            case 'INVITE_DELETE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordInviteDelete };
            ...
            case 'CHANNEL_CREATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordChannel };
            ...
            case 'GUILD_MEMBERS_CHUNK': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildMembersChunk };
            ...
            case 'RESUMED':
            case 'READY': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordReady };
            ...
            case 'VOICE_SERVER_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordVoiceServerUpdate };
            ...
            case 'USER_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordUser };
            ...
            case 'GUILD_EMOJIS_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordGuildEmojisUpdate };
            ...
            case 'CHANNEL_PINS_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordChannelPinsUpdate };
            ...
            case 'WEBHOOKS_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordWebhookUpdate };
            ...
            case 'THREAD_DELETE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: Pick<DiscordChannel, 'id' | 'guild_id' | 'parent_id' | 'type'> };
            ...
            case 'THREAD_LIST_SYNC': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordThreadListSync };
            ...
            case 'THREAD_MEMBERS_UPDATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordThreadMembersUpdate };
            ...
            case 'STAGE_INSTANCE_CREATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordStageInstance };
            ...
            case 'INTERACTION_CREATE': {
                const packet = pkt as Omit<DiscordGatewayPayload, 'd'> & { d: DiscordInteraction };
    ...
    toJSON(props = []) {
        // TODO: Update this after Shard is done
        return Base.prototype.toJSON.call(this, ['connecting', 'ready', 'discordServerTrace', 'status', 'lastHeartbeatReceived', 'lastHeartbeatSent', 'latency', 'preReady', 'getAllUsersCount', 'getAllUsersQueue', 'getAllUsersLength', 'guildSyncQueue', 'guildSyncQueueLength', 'unsyncedGuilds', 'lastHeartbeatAck', 'seq', 'sessionID', 'reconnectInterval', 'connectAttempts', ...props]);
    }
}
