...
export type ChatInputApplicationCommand =
  ApplicationCommand<ApplicationCommandTypes.ChatInput>;
export type ChatInputApplicationCommandStructure = Omit<
  ChatInputApplicationCommand,
  "id" | "application_id" | "guild_id"
>;
export type MessageApplicationCommand = Omit<
  ApplicationCommand<ApplicationCommandTypes.Message>,
  "description" | "options"
>;
export type MessageApplicationCommandStructure = Omit<
  MessageApplicationCommand,
  "id" | "application_id" | "guild_id"
>;
export type UserApplicationCommand = Omit<
  ApplicationCommand<ApplicationCommandTypes.User>,
  "description" | "options"
>;
export type UserApplicationCommandStructure = Omit<
...
export type ApplicationCommandOptionsBoolean =
  ApplicationCommandOption<ApplicationCommandOptionTypes.Boolean>;
export type ApplicationCommandOptionsChannel =
  ApplicationCommandOption<ApplicationCommandOptionTypes.Channel>;
...
export type ApplicationCommandOptionsMentionable =
  ApplicationCommandOption<ApplicationCommandOptionTypes.Mentionable>;
...
> &
  AutocompleteDisabledIntegerMinMax;
export type ApplicationCommandOptionsRole =
  ApplicationCommandOption<ApplicationCommandOptionTypes.Role>;
...
export type ApplicationCommandOptionsUser =
  ApplicationCommandOption<ApplicationCommandOptionTypes.User>;
...
// // Webhook
export type MessageWebhookContent = Pick<
  WebhookPayload,
...
export interface ApplicationCommandOption<
  ...
  >
> {
  channel_types: T extends ApplicationCommandOptionTypes.Channel
...
export interface AutocompleteDisabledIntegerMinMax
  extends AutocompleteDisabled {
  choices?: null;
}
...
export interface EditChannelOptions
  extends Omit<CreateChannelOptions, "reason"> {
  archived?: boolean;
...
export interface ListedChannelThreads<
  T extends ThreadChannel = AnyThreadChannel
> extends ListedGuildThreads<T> {
  hasMore: boolean;
}
export interface ListedGuildThreads<
  T extends ThreadChannel = AnyThreadChannel
> {
